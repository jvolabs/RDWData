...
exports.validateDutchPlate = validateDutchPlate;
exports.formatDisplayPlate = formatDisplayPlate;
const DUTCH_PLATE_SERIES = [
...
function validateDutchPlate(plate) {
    return DUTCH_PLATE_SERIES.some((series) => series.regex.test(plate));
}
function formatDisplayPlate(plate) {
